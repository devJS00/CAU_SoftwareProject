...
class DrawingPieActionListener implements ActionListener {	
	...
	public void actionPerformed(ActionEvent ae) {				
		...
		cb.setDebugEnabled(true)
		    .setOAuthConsumerKey("gBbSAEg8zdrPeqF1EfZMEdzPp")
		    .setOAuthConsumerSecret("vcGi1EQGjFHaYNvPpM40uHNugj5z1vhmtPC8CZbDxxUK1u6M4n")
		    .setOAuthAccessToken("1530731543186272256-wemTNfJAX8OccNjbs7V57CfHulKHK6")
		    .setOAuthAccessTokenSecret("SkzKVm2vbkrP9xugwN3IFF1r5PBhiZHUQJeOKroCKwRRD");
